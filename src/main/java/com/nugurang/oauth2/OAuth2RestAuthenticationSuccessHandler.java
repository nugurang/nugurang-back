...
public class OAuth2RestAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        final var responseDto = RestResponseDto.builder().data(Optional.of(authentication)).errors(Optional.empty()).build();
    ...
    public OAuth2RestAuthenticationSuccessHandler(final ResponseEntityWriter responseEntityWriter) {

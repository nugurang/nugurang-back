...
public class TeamQuery implements GraphQLQueryResolver {
    ...
    public List<TeamDto> getTeamsByName(String name, Integer page, Integer pageSize) {
        return teamService.getTeams(name, PageRequest.of(page, pageSize)).stream().map(entity -> entity.toDto()).collect(Collectors.toList());
    }

    //<editor-fold defaultstate="collapsed" desc="delombok">
    @SuppressWarnings("all")
    
    public TeamQuery(final TeamService teamService) {

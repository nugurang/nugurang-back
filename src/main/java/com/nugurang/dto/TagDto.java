...
public class TagDto {
    ...
    public static class TagDtoBuilder {
        ...
        public TagDto.TagDtoBuilder id(final Long id) {
            this.id = id;
            return this;
        }
        ...
        public TagDto.TagDtoBuilder name(final String name) {
            this.name = name;
            return this;
        }
        ...
        public String toString() {
            return "TagDto.TagDtoBuilder(id=" + this.id + ", name=" + this.name + ")";
        }
    }

    @SuppressWarnings("all")
    
    public static TagDto.TagDtoBuilder builder() {
